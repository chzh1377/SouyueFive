...
//            ll.addView(tw, new LinearLayout.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT, 0));
            addView(tw,new FrameLayout.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.FILL_PARENT));
...
//        mRealTabContent.setId(containerId);
    ...
    public void addTab(TabHost.TabSpec tabSpec, Class<?> clss, Bundle args, boolean... detach) {
    ...
    private void hideOrDetach(FragmentTransaction ft, TabInfo tab) {
        ...
        tab.fragment.setUserVisibleHint(false);
    }
